...
mydata1 <- lfs_od20 %>%  
  select(PERSNO, PWT18, JBTP101, FTPT, INECAC05, JOBTYP, SEX)
head(mydata1)
...
frq(mydata1$JBTP101, weights = mydata1$PWT18)
frq(mydata1$FTPT, weights = mydata1$PWT18)
frq(mydata1$INECAC05, weights = mydata1$PWT18)
frq(mydata1$JOBTYP, weights = mydata1$PWT18)
frq(mydata1$SEX, weights = mydata1$PWT18)
...
mydata1 <- filter (mydata1, PWT18>0)
